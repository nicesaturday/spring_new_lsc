...
<body>
	...
	<script>
		...
		function detail(e) {
			...
			$('.modal-title').html($(e).find('.thumbnail-title').text());
				...
				<div class="row">
				 ...
				 <c:forEach items="${ board }" var="img">
					<div class="col-md-4 col-sm-6 portfolio-item" onclick="detail(this)">
					  <input type="hidden" class="thumbnail-date" name="" value="${ img.createDate }">
					  <input type="hidden" class="thumbnail-content" name="" value="${ img.boardContent }">
						<a class="portfolio-link" data-toggle="modal" href="#MyModal">
							<div class="portfolio-hover">
								<div class="portfolio-hover-content">
								</div>
							</div>
							<img class="thumbnail-img img-fluid"
							     style="height: 70%;"
							      src="${ img.changeName }" alt="게시글 이미지">
						</a>
						<div class="portfolio-caption">
							<h4 class="thumbnail-title">${ img.boardTitle }</h4>
							<p class="thumbnail-writer">${ img.boardWriter }</p>
						</div>
					</div>
				  </c:forEach>
				</div>
		        ...
		        <div class="modal-body">
			        <div class="table-center">
			            <table class="intro-table">
			                <tr class="intro-tr">
			                    <td colspan="2">
			                        <img id="img-modal" class="img-fluid" src="" alt="" height="40%">
			                    </td>
			                </tr>
			                <tr class="intro-tr">
